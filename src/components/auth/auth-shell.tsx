      ...
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[var(--r-xl)] border border-line shadow-[var(--shadow)] lg:grid-cols-2">
        <div className="relative hidden min-h-[600px] lg:block">
          ...
          <div className="absolute inset-x-0 bottom-0 p-8">
            <span className="inline-flex h-8 w-8 text-honey"><MoonMark /></span>
  ...
  return (
    <Button type="button" variant="outline" size="lg" onClick={onClick} className="w-full gap-3">
      <svg aria-hidden="true" viewBox="0 0 48 48" className="h-5 w-5">
        ...
        <path fill="#FBBC05" d="M10.58 28.73A14.6 14.6 0 0 1 9.82 24c0-1.65.29-3.25.76-4.73V13.25H2.83A24 24 0 0 0 0 24c0 3.87.93 7.54 2.83 10.75l7.75-6.02z" />
