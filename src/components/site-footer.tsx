    ...
    <footer className="mt-24 bg-espresso text-on-dark">
      <div className="mc-container py-16 md:py-20">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
            ...
            <div className="mt-6 flex items-center gap-2">
              ...
              <Social label="Pinterest" href="#">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M12 2a10 10 0 0 0-3.6 19.3c-.1-.8-.2-2 0-2.9l1.2-5s-.3-.6-.3-1.5c0-1.4.8-2.4 1.8-2.4.9 0 1.3.6 1.3 1.4 0 .9-.5 2.1-.8 3.3-.2.9.5 1.7 1.4 1.7 1.7 0 2.9-2.2 2.9-4.7 0-2-1.3-3.4-3.7-3.4a4.2 4.2 0 0 0-4.4 4.2c0 .8.3 1.4.6 1.8l-.3 1c0 .2-.2.3-.4.2-1.1-.5-1.7-2-1.7-3.2 0-2.6 1.9-5 5.6-5 2.9 0 5.2 2.1 5.2 4.9 0 2.9-1.8 5.3-4.4 5.3-.9 0-1.7-.5-2-1l-.5 2c-.2.8-.8 1.8-1.2 2.4A10 10 0 1 0 12 2z"
                />
              </Social>
            </div>
          </div>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-display text-lg text-on-dark">
              Letters from the moon
            </h3>
            <p className="mt-2 text-sm text-on-dark/70">
              Seasonal arrivals and gifting ideas, a few times a year. Never
              noise.
            </p>
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-white/10 pt-6 text-xs text-on-dark/55 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <span aria-hidden className="text-on-dark/25">
              ·
            </span>
            <a
