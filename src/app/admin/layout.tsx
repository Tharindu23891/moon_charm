...
const nav = [
  { href: '/admin', label: 'Overview', exact: true, d: 'M4 4h7v7H4zM13 4h7v7h-7zM4 13h7v7H4zM13 13h7v7h-7z' },
  { href: '/admin/products', label: 'Products', d: 'M20.6 13.4 13.4 20.6a2 2 0 0 1-2.8 0l-6.2-6.2a2 2 0 0 1-.6-1.4V5a1 1 0 0 1 1-1h7a2 2 0 0 1 1.4.6l6.4 6.4a2 2 0 0 1 0 2.4zM8 8h.01' },
  { href: '/admin/packages', label: 'Packages', d: 'M21 8 12 3 3 8l9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8' },
  { href: '/admin/categories', label: 'Categories', d: 'M3 7h7v5H3zM14 7h7v10h-7zM3 14h7v3H3z' },
  { href: '/admin/orders', label: 'Orders', d: 'M5 4h11l3 4v12a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1zM8 11h8M8 15h6' },
];
    ...
    <div className="mc-container mc-container-wide py-8 md:py-10">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[218px_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <p className="px-3 text-xs font-semibold uppercase tracking-[0.14em] text-faint">Admin</p>
