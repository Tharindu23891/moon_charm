...
const sections = [
  {
    href: '/admin/products',
    title: 'Products',
    desc: 'Add, edit, and remove individual gift items.',
  ...
  },
  {
    href: '/admin/packages',
    title: 'Packages',
    desc: 'Bundle products into ready-to-give gift packages.',
    d: 'M21 8 12 3 3 8l9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8',
  },
  {
    href: '/admin/categories',
    title: 'Categories',
    desc: 'Manage the occasions gifts are organised under.',
    d: 'M3 7h7v5H3zM14 7h7v10h-7zM3 14h7v3H3z',
  },
  {
    href: '/admin/orders',
    title: 'Orders',
    desc: 'Review orders and move them through fulfilment.',
...
export default function AdminHomePage() {
  return (
    <div>
      <AdminHeader
        title="Dashboard"
        description="Manage the catalogue and keep orders moving."
      />
            ...
            <div>
              <div className="flex items-center gap-1.5 font-display text-lg">
                ...
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth="1.8"
                  className="h-4 w-4 text-muted-foreground transition-transform duration-300 group-hover:translate-x-1 group-hover:text-primary"
                >
                  <path
                    strokeLinecap="round"
