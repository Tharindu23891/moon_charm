...
export default async function ProfilePage() {
  ...
  return (
    <div className="mc-container max-w-3xl py-12 md:py-16">
      ...
      <h1 className="mt-4 font-display text-[clamp(2rem,4vw,2.8rem)]">
        Hello, {name}
      </h1>
      ...
      <div className="mt-8 rounded-[var(--r-lg)] border border-line bg-surface p-6 sm:p-8">
        <div className="flex items-center gap-4">
          ...
          {role === 'admin' ? (
            <Badge variant="blush" className="ml-auto">
              Admin
            </Badge>
          ) : null}
        </div>
        ...
        <dl className="mt-7 grid gap-4 border-t border-line pt-6 sm:grid-cols-2">
          <div>
            <dt className="text-xs tracking-[0.1em] text-faint uppercase">
              Name
            </dt>
