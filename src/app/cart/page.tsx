...
const FALLBACK =
  'https://images.unsplash.com/photo-1513201099705-a9746e1e201f?auto=format&fit=crop&w=400&q=70';
    ...
    return (
      <div className="mc-container py-20">
        <div className="mx-auto flex max-w-md flex-col items-center text-center">
          <span className="h-12 w-12 text-primary">
            <MoonMark />
          </span>
          <h1 className="mt-5 font-display text-3xl">Your cart is empty</h1>
          <p className="mt-3 text-muted-foreground">
            Nothing chosen yet. Browse the shop, or start with a ready-made gift
            package.
          </p>
          ...
          {items.map((it) => {
            ...
            return (
              <li key={it.refId} className="flex gap-4 py-5 sm:gap-5">
                <Link
                  href={href}
                  className="relative h-24 w-20 shrink-0 overflow-hidden rounded-[var(--r)] bg-surface sm:h-28 sm:w-24"
                >
                  <Image
                ...
                <div className="flex flex-1 flex-col">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-0.5 text-xs tracking-wide text-faint uppercase">
